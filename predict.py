...
def process_pipeline(index, original_block):
    ...
    measured_block = Processor.measure_incircle(index, original_block, edge_detected_block)
...
if __name__ == "__main__":
    ...
    for image_path in image_path_list:
        ...
        processed_image.save('output/predict_result_{}'.format(os.path.basename(image_path)))
