...
if __name__ == "__main__":
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    # model_path  = "/home/mindspore/syf/unet/unet-pytorch/model_data/unet_vgg_voc.pth"
    model_path = ""
    #-----------------------------------------------------#
    ...
    #   数据集路径
    #------------------------------#
    # VOCdevkit_path  = '/home/mindspore/syf/unet-resnet/VOCdevkit'
    VOCdevkit_path  = '/home/mindspore/zxy/TB-VOC/'
    #------------------------------------------------------------------#
    #   建议选项：
    #   种类少（几类）时，设置为True
    ...
    #   读取数据集对应的txt
    #---------------------------#
    with open(os.path.join(VOCdevkit_path, "/home/mindspore/syf/unet/unet-pytorch/VOCdevkit/ImageSets/Segmentation/train.txt"),"r") as f:
        train_lines = f.readlines()
    with open(os.path.join(VOCdevkit_path, "/home/mindspore/syf/unet/unet-pytorch/VOCdevkit/ImageSets/Segmentation/val.txt"),"r") as f:
